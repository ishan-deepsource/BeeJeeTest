...
class Model
{
    ...
    public const COLUMN_INSERT_COLUMN = '';
    public const COLUMN_UPDATE_COLUMN = '';
    ...
    public function insert(): bool
    {
        ...
        if ($column = static::COLUMN_INSERT_COLUMN) {
            $this->{$column} = $newer[$column] = $_SERVER['REQUEST_TIME'];
        }

        if ($column = static::COLUMN_UPDATE_COLUMN) {
            $this->{$column} = $newer[$column] = $_SERVER['REQUEST_TIME'];
        }
